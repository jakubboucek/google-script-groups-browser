...
const COMPANY_GSUITE_DOMAIN = "acme.com";
...
const WEB_ARCHIV_URL = "https://groups.google.com/a/" + COMPANY_GSUITE_DOMAIN + "/group/%s";

function doGet(): HtmlOutput {
    return HtmlService.createHtmlOutputFromFile('Index')
        .setTitle(COMPANY_NAME + ' Google Groups Directory')
        .setFaviconUrl('https://jakubboucek.github.io/google-script-groups-browser/assets/favicon.ico')
